...
public class JavaSteamAPI4 {

	public static void main(String[] args) {
		List<Product4> productList=new ArrayList<Product4>();
		
		productList.add(new Product4(1,"HP Laptop",25000f));
		productList.add(new Product4(2,"Lenovo Laptop",56000f));
		productList.add(new Product4(3,"Dell Laptop",20000f));
		productList.add(new Product4(4,"ASUS Laptop",52000f));
